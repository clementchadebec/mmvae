...
#python3 src/main.py --model jnf_mnist_svhn --obj jmvae_nf --latent-dim 20 --beta 1 --beta-prior 0.1 --warmup 40 --epochs 45 --beta-rec 1 --fix-decoders
#python3 src/main.py --model jnf_mnist_svhn --obj jmvae_nf --latent-dim 20 --beta 1 --beta-prior 1 --warmup 15 --epochs 45 --beta-rec 1 --fix-decoders --skip-warmup --no-nf
