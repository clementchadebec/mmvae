...
#python3 src/main.py --model jnf_mnist_fashion --obj jmvae_nf --latent-dim 5 --beta 1 --data-path ../data/unbalanced/  --beta-prior 1 --warmup 10 --epochs 20 --beta-rec 1 --fix-decoders --no-nf
