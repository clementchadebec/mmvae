...
class CoupledOptimizerAdversarialTrainer(BaseTrainer):
    ...
    Args:
        ...
        encoder_optimizer (~torch.optimizer.Optimizer): An instance of `torch.optimizer.Optimizer`
            used for training the encoder. If None, a :class:`~torch.optimizer.Adam` optimizer is
            used. Default: None.

        decoder_optimizer (~torch.optimizer.Optimizer): An instance of `torch.optimizer.Optimizer`
            used for training the decoder. If None, a :class:`~torch.optimizer.Adam` optimizer is
            used. Default: None.

        discriminator_optimizer (~torch.optimizer.Optimizer): An instance of `torch.optimizer.Optimizer`
            used for training the discriminator. If None, a :class:`~torch.optimizer.Adam` optimizer is
            used. Default: None.
    """
