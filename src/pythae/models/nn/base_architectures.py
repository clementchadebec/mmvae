...
class BaseEncoder(nn.Module):
    ...
    def forward(self, x):
        ...
        .. code-block::
            ...
            >>> from mmvae.src.pythae import BaseEncoder
            >>> from mmvae.src.pythae import ModelOutput
            ...
...
class BaseDecoder(nn.Module):
    ...
    def forward(self, z: torch.Tensor):
        ...
        .. code-block::
            ...
            >>> from mmvae.src.pythae import BaseDecoder
            >>> from mmvae.src.pythae import ModelOutput
            ...
...
class BaseMetric(nn.Module):
    ...
    def forward(self, x):
        ...
        .. code-block::
            ...
            >>> from mmvae.src.pythae import BaseMetric
            >>> from mmvae.src.pythae import ModelOutput
            ...
...
class BaseDiscriminator(nn.Module):
    ...
    def forward(self, x):
        ...
        .. code-block::
            ...
            >>> from mmvae.src.pythae import BaseDiscriminator
            >>> from mmvae.src.pythae import ModelOutput
            ...
