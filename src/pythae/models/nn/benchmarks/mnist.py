...
class Encoder_AE_MNIST(BaseEncoder):
    ...
    .. code-block::
            ...
            >>> from mmvae.src.pythae import Encoder_AE_MNIST
...
class Encoder_VAE_MNIST(BaseEncoder):
    ...
    .. code-block::
            ...
            >>> from mmvae.src.pythae import Encoder_VAE_MNIST
...
class Encoder_SVAE_MNIST(BaseEncoder):
    ...
    .. code-block::
            ...
            >>> from mmvae.src.pythae import Encoder_SVAE_MNIST
...
class Decoder_AE_MNIST(BaseDecoder):
    ...
    .. code-block::
            ...
            >>> from mmvae.src.pythae import Decoder_AE_MNIST
            >>> from mmvae.src.pythae import VAEConfig
            >>> model_config = VAEConfig(input_dim=(1, 28, 28), latent_dim=16)
...
class Discriminator_MNIST(BaseDiscriminator):
    ...
    .. code-block::
            ...
            >>> from mmvae.src.pythae import Discriminator_MNIST
