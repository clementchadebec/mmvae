...
from mmvae.src.pythae.models.nn import BaseDiscriminator
...
class Encoder_AE_CELEBA(BaseEncoder):
    ...
    .. code-block::
            ...
            >>> from mmvae.src.pythae import Encoder_AE_CELEBA
            >>> from mmvae.src.pythae import AEConfig
    ...
    and then passed to a :class:`pythae.models` instance
        ...
        >>> from mmvae.src.pythae import AE
...
class Encoder_VAE_CELEBA(BaseEncoder):
    ...
    .. code-block::
            ...
            >>> from mmvae.src.pythae import Encoder_VAE_CELEBA
            >>> from mmvae.src.pythae import VAEConfig
    ...
    and then passed to a :class:`pythae.models` instance
        ...
        >>> from mmvae.src.pythae import VAE
...
class Encoder_SVAE_CELEBA(BaseEncoder):
    ...
    .. code-block::
            ...
            >>> from mmvae.src.pythae import Encoder_SVAE_CELEBA
            >>> from mmvae.src.pythae import SVAEConfig
    ...
    and then passed to a :class:`pythae.models` instance
        ...
        >>> from mmvae.src.pythae import SVAE
...
class Decoder_AE_CELEBA(BaseDecoder):
    ...
    .. code-block::
            ...
            >>> from mmvae.src.pythae import Decoder_AE_CELEBA
            >>> from mmvae.src.pythae import VAEConfig
            >>> model_config = VAEConfig(input_dim=(3, 64, 64), latent_dim=64)
...
class Discriminator_CELEBA(BaseDiscriminator):
    ...
    .. code-block::
            ...
            >>> from mmvae.src.pythae import Discriminator_CELEBA
            >>> from mmvae.src.pythae import VAEGANConfig
    ...
    and then passed to a :class:`pythae.models` instance
        ...
        >>> from mmvae.src.pythae import VAEGAN
