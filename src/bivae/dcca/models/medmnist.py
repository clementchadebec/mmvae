...
class DeepCCA_MedMNIST(nn.Module):
    ...
    def __init__(self, outdim_size, use_all_singular_values, device=torch.device('cpu')):
        ...
        self.model1 = Encoder_ResNet_AE_medmnist(VAEConfig((3,28,28), outdim_size))
        self.model2 = Encoder_ResNet_AE_medmnist(VAEConfig((3,28,28), outdim_size))
...
def load_dcca_medmnist(outdim_size):
    ...
    model1 = Encoder_ResNet_AE_medmnist(VAEConfig((3,28,28), outdim_size))
    model2 = Encoder_ResNet_AE_medmnist(VAEConfig((3,28,28), outdim_size))
