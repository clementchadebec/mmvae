...
from bivae.my_pythae.models.nn import (BaseDecoder, BaseDiscriminator, BaseEncoder,
                                        BaseMetric)
    ...
    def forward(self, z: torch.Tensor, output_layer_levels: List[int] = None):
        ...
        for i in range(max_depth):
            ...
            if i + 1 == self.depth:
                ...
                output["reconstruction"] = output["reconstruction"].clamp(Constants.eta, 1-Constants.eta)
        return output
