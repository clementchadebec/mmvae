...
class laplace_VAE(BaseAE):
    """

    Variational Autoencoder with Laplace prior and posterior and Softmax layer at the end of encoder
    """
    ...
    def forward(self, x, **kwargs):
        ...
        z = dist.Laplace(mu, std).rsample()

        recon_x = self.decoder(z)["reconstruction"]

        # loss, recon_loss, kld = self.loss_function(recon_x, x, mu, log_var, z)
        loss, recon_loss, kld = None, None, None
